            ...
            <div class="col-md-2">
                <div class="row border border-secondary rounded pt-3 mr-1 pb-4 ">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input value="{{ \Carbon\Carbon::now()->format('d F Y') }}" class="form-control form-control-sm"
                            disabled type="text">
                    </div>
                </div>
            </div>
                ...
                <div class="row pt-3">
                    <div class="col-5">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input id="teleponpelanggan" class="form-control form-control-sm" style="width:80%" disabled
                                type="text">
                        </div>
                    </div>
                    <div class="col-7">
                    ...
                    <div class="row ">
                        <div class="col-2">
                            <div class="form-group ml-5">
                                ...
                                <input id="kodebarang" type="text" disabled id="kode"
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="hargabarang" disabled id="harga" value="0"
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input id="jumlahbarang" type="text" disabled value="0" id="jumlah"
                                    class="form-control form-control-sm inputharga">
                            </div>
                        </div>
                        <div class="col-1">
                            <div class="form-group" style="margin-top:30px">
                                <button disabled type="button" id="tambahbarang" class="btn-sm btn-info form-control"
                                    style="width:40px; height:35px"><i class="fa fa-plus"></i></button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" id="form-add-pelanggan" enctype="multipart/form-data">
                    ...
                    <div class="form-group row add">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" id="addnamapelanggan" class="form-control" id="nama" name="nama"
                    ...
                    <div class="form-group row add">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" id="addteleponpelanggan" class="form-control" id="telepon"
                    ...
                    <div class="form-group row add">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" id="addalamatpelanggan" class="form-control" id="alamat"
                                    name="alamat" placeholder="Alamat Pelanggan">
                            </div>
                        </div>
                    </div>
